...
import TransportTableItem from "./tableItem/transportertableitem"
import {connect} from "react-redux"
//import {getadmin} from "../../../action/adminACtion"
import PropTypes from 'prop-types';


export class transorttable extends Component {
    componentDidMount() {
      //  getadmin()
  ...
  render() {
    ...
    let item = adminData.transportdata.map(data =>(<TransportTableItem key={data.name} data={data} />))
...
transorttable.ProtoTypes={
  ...
  export default connect(mapStateToProps,{})(transorttable);