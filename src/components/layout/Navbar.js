...
class Navbar extends Component {
  ...
  render() {
    return (
        ...
        <div id="wrapper" onClick={this.clicked}>
                            ...
                            <li>
                                <div id="navbar-menu">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="create_new icon-menu" title="Create New">Create
                                                New</a>
                                        </li>
                                        <li class="dropdown">
                                        ...
                                        <li class="dropdown">
                                            <a href="javascript:void(0);" class="dropdown-toggle icon-menu" data-toggle="dropdown"><i
                                                    class="icon-flag"></i><span class="notification-dot"></span></a>
                                            ...
                                            <div class="dropdown-menu animated flipInY user-profile">
                                                <div class="d-flex p-3 align-items-center">
                                                    <div class="drop-left m-r-10">
                                                        <img src="../assets/images/user-small.png" class="rounded" width="30"
                                                            alt=""/>
                                                    </div>
                                                ...
                                                <div class="m-t-10 p-3 drop-list">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li><Link to="/authoriazation"><i class="icon-envelope-open"></i>Messages</Link></li>
